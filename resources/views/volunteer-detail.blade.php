                        ...
                        <div class="h-100">
                            <div class="row justify-content-center align-items-center h-100">
                                <div class="project-title" id="dsn-hero-parallax-title">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Location, Topic etc" style="border: 1px solid #ddd;border-radius: 10px;width: 60%;min-height: 60px !important;padding: 0 30px;">
